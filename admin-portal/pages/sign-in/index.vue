<script setup lang="ts">
	...
	const redirectUrl = 'https://nguoivietnew.com';
	...
	function handleToken(e: StorageEvent) {
		...
		<section class="space-y-8" >
			...
			<form @submit.prevent="login()"
				...
				<div class="flex justify-between items-center">
					...
					<button class="text-indigo-600 hover:indigo-700">
						Quên mật khẩu?
					</button>
				</div>
				...
				<button type="submit"
						...
						class="block w-full text-white bg-red-500 rounded-md py-2 disabled:opacity-60">
					Đăng Nhập
				</button>

				<div class="flex items-center text-gray-500">
					<hr class="flex-1">
					<h3 class="px-2">Đăng nhập với</h3>
					<hr class="flex-1">
				</div>
